...
module input_printer_12 (
  ...
  localparam SPEED = 3'h5;
  localparam BLINK_SPEED = 5'h1b;
  
  
  wire [1-1:0] M_slowclock_value;
  counter_24 slowclock (
    .rst(1'h0),
    .clk(clk),
  ...
  grid_selector_26 player0_occupancy_select (
  ...
  grid_selector_26 player1_occupancy_select (
    .select(M_row_iterator_q),
  ...
  grid_selector_26 selection_occupancy_select (
    .select(M_row_iterator_q),
  ...
  always @* begin
    ...
    column0 = M_player0_occupancy_select_out | (M_selection_occupancy_select_out & ({4'h9{M_blink_slowclock_value}}));
    column1 = M_player1_occupancy_select_out | (M_selection_occupancy_select_out & ({4'h9{M_blink_slowclock_value}}));
  end
